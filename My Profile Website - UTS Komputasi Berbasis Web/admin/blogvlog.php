...
if ($op == 'delete') {
    $id = $_GET['id'];
    $sql1 = "DELETE FROM blogvlog WHERE id = '$id'";
...
?>
<h1>Admin Page Blog/Vlog</h1>
<p>
    <a href="blogvlog_input.php">
...
<section class="flex-grow-1">
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            $sql1   = "SELECT * FROM blogvlog $sqlAdding";
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="blogvlog_input.php?id=<?php echo $r1['id']?>">
                            <span class="badge bg-warning text-dark">Edit</span>
                        </a>
                        <a href="blogvlog.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Apakah yakin ingin menghapus data?')">
    ...
    <nav aria-label="Page navigation example" class="">
            <ul class="pagination">
                ...
                for($i = 1; $i <= $pages; $i++) {
                    ?>
                    <li class="page-item">
                        <a class="page-link" href="blogvlog.php?keyword=<?php echo $keyword ?> &search=<?php echo $search?> &page=<?php echo $i?> "><?php echo $i ?></a>
                    </li>
                    <?php
                }            
                ?>
