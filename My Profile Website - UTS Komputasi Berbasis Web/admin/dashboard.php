...
if ($op == 'delete') {
    $id = $_GET['id'];
    $sql1 = "DELETE FROM dashboard WHERE id = '$id'";
...
<section class="flex-grow-1">
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            $sql1   = "SELECT * FROM dashboard $sqlAdding";
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="dashboard_input.php?id=<?php echo $r1['id']?>">
                            <span class="badge bg-warning text-dark">Edit</span>
                        </a>
                        <a href="dashboard.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Apakah yakin ingin menghapus data?')">
    ...
    <nav aria-label="Page navigation example" class="">
            <ul class="pagination">
                ...
                for($i = 1; $i <= $pages; $i++) {
                    ?>
                    <li class="page-item">
                        <a class="page-link" href="dashboard.php?keyword=<?php echo $keyword ?> &search=<?php echo $search?> &page=<?php echo $i?> "><?php echo $i ?></a>
                    </li>
                    <?php
                }            
                ?>
