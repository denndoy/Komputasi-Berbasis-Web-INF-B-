...
<section class="flex-grow-1">
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            $sql1   = "SELECT * FROM about $sqlAdding";
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="about.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Apakah yakin ingin menghapus data?')">
    ...
    <nav aria-label="Page navigation example" class="">
            <ul class="pagination">
                ...
                for($i = 1; $i <= $pages; $i++) {
                    ?>
                    <li class="page-item">
                        <a class="page-link" href="about.php?keyword=<?php echo $keyword ?> &search=<?php echo $search?> &page=<?php echo $i?> "><?php echo $i ?></a>
                    </li>
                    <?php
                }            
                ?>
